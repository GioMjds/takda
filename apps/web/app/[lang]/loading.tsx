    ...
    >
      ...
      <div
        ...
        className="
          ...
          bg-[radial-gradient(circle,rgba(29,158,117,0.18)_0%,rgba(29,158,117,0.05)_45%,transparent_72%)]
          blur-3xl
        "
      />
      <div
        ...
        className="
          ...
          bg-[radial-gradient(circle,rgba(217,158,73,0.12)_0%,rgba(217,158,73,0.04)_45%,transparent_72%)]
          blur-3xl
        "
      />
      ...
      <div className="relative z-10">
        ...
        <section
          className="
            ...
            px-6 pt-20 pb-16 text-center sm:px-8 sm:pt-28 sm:pb-20
          "
        >
              ...
              <div className="space-y-5 border-b border-white/6 p-5 sm:p-7 lg:border-b-0 lg:border-r">
                ...
                <div className="grid grid-cols-3 gap-1.5">
                  {Array.from({ length: 9 }).map((_, i) => (
                    <Skeleton
                      key={i}
                      className="h-8 rounded-md bg-white/4"
                    />
                  ))}
                </div>
